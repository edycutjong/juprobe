    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-8 max-w-3xl mx-auto">
      <div className="w-full space-y-8">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-bold text-white tracking-tight">JupProbe</h1>
          <p className="text-lg text-slate-400">Jupiter API Monitor</p>
        </div>

        <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6 space-y-4">
          <h2 className="text-sm font-bold text-slate-300 tracking-wider">WHAT IT DOES</h2>
          <p className="text-sm text-slate-400 leading-relaxed">
            Real-time health monitoring and latency benchmarking for all Jupiter DEX aggregator API endpoints.
          </p>
        </div>
